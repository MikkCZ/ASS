...
class MyPlayer:
    ...
    def move(self):
        ...
        my_list = self.list_of_my_moves[-11:-1]
        opponents_list = self.list_of_opponents_moves[-10:]
        ...
        # After twelve iterations checks whether the opponent repeats my last moves. If so, try to to reach the highest score together.
        if iteration > 12 and my_list == opponents_list:
